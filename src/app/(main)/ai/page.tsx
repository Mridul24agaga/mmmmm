...
const DISCLAIMER = `Disclaimer: The responses provided by Virtual Companion are generated by an AI tool and are not created by a human or a licensed professional. This feature is designed to provide comfort and support through virtual companionship but is not a substitute for professional counseling or advice. For personal guidance, please consult a qualified professional.`
...
export default function Component() {
  ...
  const [spellingSwitchOn, setSpellingSwitchOn] = useState(false)
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      content = spellingSwitchOn ? simulateTypingErrors(content) : content
  ...
  return (
    <div className="h-[calc(100vh-4rem)] md:h-[calc(100vh-8rem)] bg-white flex">
        ...
        {chatbot ? (
          <div className="flex flex-col h-full w-full">
              ...
              <AnimatePresence>
                {isDiaryMode ? (
                  diaryEntries.map((entry, index) => (
                    ...
                    >
                      <div className="inline-block p-2 md:p-3 rounded-lg max-w-[80%] md:max-w-[70%] bg-purple-100 text-purple-800">
            ...
            <div className="bg-white p-3 md:p-4 border-t border-gray-200">
              ...
              <div className="flex items-center justify-end mb-2">
                <label htmlFor="diary-toggle" className="mr-2 text-xs text-gray-500">Diary mode</label>
                <button
                  id="diary-toggle"
                  onClick={() => setIsDiaryMode(!isDiaryMode)}
                  className={`w-10 h-5 rounded-full focus:outline-none transition-colors duration-200 ease-in-out ${isDiaryMode ? 'bg-purple-500' : 'bg-gray-300'}`}
                >
                  <span className={`block w-4 h-4 rounded-full bg-white transform transition-transform duration-200 ease-in-out ${isDiaryMode ? 'translate-x-5' : 'translate-x-1'}`} />
                </button>
              </div>
              {limitReachedMessage && (
              ...
              <div className="flex items-center">
                <input
                  ...
                  placeholder={isDiaryMode ? "Write in your diary..." : "Type your message"}
      ...
      {showDisclaimer && (
        <div className="fixed bottom-4 left-4 right-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded shadow-md max-w-md mx-auto">
